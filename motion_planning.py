...
class MotionPlanning(Drone):
    ...
    def __init__(self, connection, args_opt):
        ...
        self.check_state = {}
        self.goal = args_opt["goal"]
        self.helix = args_opt["helix"]
...
if __name__ == "__main__":
    ...
    parser.add_argument('--goal', type=str, default='-122.396153, 37.797438, 0', help="lon/lat/alt")
    parser.add_argument('--helix', type=bool, default=False, help="Fly a helix")
    ...
    drone = MotionPlanning(conn, args_opt)
    time.sleep(1)
